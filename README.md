...
Voici la ligne de code présentant lévolution sur 6 mois :
'''
...
def nb_oeuf_par_semaine1(k):
    #Avant 14 semaines
    if k<=14:
        nb_oeufs=int((-2.6064*k*k*k)+(33.363*k*k)+(22.356*k)+1000)
    else:
    #Apres 14 semaines
        nb_oeufs=int((0.3906*k*k*k*k)+(-31.539*k*k*k)+(929*k*k)+(-11826*k)+55718)
